...
If there's no such next greater element for a particular index, the value at that index in the output array should be -1. For example, given array = [1, 2], 
...
So the next index after the last index in a circular array is the first index. This means that, for our problem, given array = [0, 0, 5, 0, 0, 3, 0 0], 
...
Solutions uses a stack to keep track of indices. This way we can achieve O(N) complexity

*/

function nextGreaterElement(array) {
    let stack = []
      let result = [...array].fill(-1)
